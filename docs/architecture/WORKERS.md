...
Responsibilities:
- intake and trace for legacy or bridge workflows
- promotion into canonical member/core flows
- controlled migration support outside core production contracts
