...
Repository note:
- worker code now lives under `workers/`
...
### Main responsibility
- intake and trace legacy or bridge workflows
- promote usable records into the canonical system
- support migration without breaking production contracts
